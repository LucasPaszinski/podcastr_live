...
%Podcast{} =
  ...
  Repo.insert!(
    Podcast.changeset(%Podcast{}, %{
      "url" => "a-importancia-da-contribuicao-em-open-source",
...
%Podcast{} =
  ...
  Repo.insert!(
    Podcast.changeset(%Podcast{}, %{
      "url" => "uma-conversa-sobre-programacao-funcional-e-orientacao-a-objetos",
      "title" =>
...
%Podcast{} =
  ...
  Repo.insert!(
    Podcast.changeset(%Podcast{}, %{
      "url" => "barreiras-e-solucoes-propostas-por-micro-servicos",
...
%Podcast{} =
  ...
  Repo.insert!(
    Podcast.changeset(
      %Podcast{},
      %{
        "url" => "aplicacao-de-arquiteturas-mvc-e-clean-architecture-na-pratica",
...
%Podcast{} =
  ...
  Repo.insert!(
    Podcast.changeset(%Podcast{}, %{
      "url" => "entrevista-jose-valim-criador-do-elixir",
      "title" =>
...
%Podcast{} =
  ...
  Repo.insert!(
    Podcast.changeset(%Podcast{}, %{
      "url" => "como-virar-lider-desenvolvimento",
...
%Podcast{} =
  ...
  Repo.insert!(
    Podcast.changeset(%Podcast{}, %{
      "url" => "estrategias-de-autenticacao-jwt-oauth",
